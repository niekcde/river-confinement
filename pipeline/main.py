...
def _step2_multi_input(continent_input, config_path=None, conf_factor=50, number_of_processors=None):
    import pandas as pd
...
def run_geometry_cli(continent_input, number_of_processors, config_path=None, conf_factor=50):
    ...
    multi_input = _step2_multi_input(
...
def run_cli(continent_input, number_of_processors, config_path=None, conf_factor=50):
    multi_input = _step2_multi_input(
        continent_input=continent_input,
        config_path=config_path,
        conf_factor=conf_factor,
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Step 2 entrypoint: run the first confinement-metric pass on segmented reaches."
    )
